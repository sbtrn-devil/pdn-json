...
// This is the actual PDN-JSON plugin version to use for PDN 4.1.x+ (and 5.x?)

namespace PdnJsonFileType
{
	public sealed class PdnJsonFileTypeFactory : IFileTypeFactory
	{
		public FileType[] GetFileTypeInstances()
		{
			return new[] { new PdnJsonFileTypePlugin() };
		}
	}

	[PluginSupportInfo(typeof(PluginSupportInfo))]
	internal class PdnJsonFileTypePlugin : FileType
	{
		...
		/// </summary>
		internal PdnJsonFileTypePlugin()
			: base(
				"PDN via JSON",
				new FileTypeOptions
				{
					LoadExtensions = new string[] { ".pdn-json" },
					SaveExtensions = new string[] { ".pdn-json" },
					SupportsLayers = true
				})
		{
		}
